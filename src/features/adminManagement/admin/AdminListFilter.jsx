    ...
    <div className="overview-filter mt-1 mb-3">
      <div className="row align-items-center">
        ...
        <div className='col-md-4 text-end'>
            <button  className ="btn btn-primary blue-btn" onClick={handleOpenCanvas}><span className='fs-18 pe-2'>+</span>Add Admin</button>
        </div>
      </div>
        <CustomOffcanvas title="New Admin" children={<AdminForm show={showOffCanvas} onClose={handleCloseCanvas}  />} show={showOffCanvas} onClose={handleCloseCanvas} height='60vh'/>
    </div>
  );
};
