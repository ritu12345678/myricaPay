...
const BroadcastFilterSection = ({ openCanvas }) => {
      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-8 d-flex align-items-center flex-nowrap gap-2">
          ...
          <Dropdown
            ...
            style={{ minWidth: 140 }}
          />
          <button type="button" className="btn btn-primary btn-outline-secondary transparent-btn " onClick={() => setShowDataModal(true)}> <img className="mb-1 pe-1" src={exporticon} alt="Add" style={{ width: 18, height: 18 }} />Export</button>
        </div>
...
export default BroadcastFilterSection;
